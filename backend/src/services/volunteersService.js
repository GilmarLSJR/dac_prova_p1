...
class VolunteersService {
    ...
    static async getByID(id) {
        ...
        if (!getUsersByID) {
            throw new Error('Voluntário não encontrado.'); // Caso nenhum usuário tenha sido encontrado
        }
        return getUsersByID;
    }
    ...
    static async create(user) {
        ...
        return await VolunteersModel.create(users); // Cria um novo voluntário
    }
    ...
    // Deleta um voluntário pelo ID static
