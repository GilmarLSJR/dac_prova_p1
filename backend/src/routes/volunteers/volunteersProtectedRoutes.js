...
const volunteersProtectedController = require('../../controllers/volunteers/volunteersProtectedController');
...
router.get(
  ...
  authenticateToken,
  authorizeRole('admin'),
  volunteersProtectedController.adminOnly_getAll
);
...
router.get(
  ...
  authenticateToken,
  authorizeRole('admin'),
  volunteersProtectedController.getByID
);
...
router.put(
  ...
  authenticateToken,
  authorizeRole('admin'),
  volunteersProtectedController.update
);
...
router.delete(
  ...
  authenticateToken,
  authorizeRole('admin'),
  volunteersProtectedController.adminOnly_delete
);
