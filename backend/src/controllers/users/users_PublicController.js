...
class Users_PublicController {

    // Método para criar um novo usuário
    static async create(req, res) {
        console.log('users_publicController_create');
        try {
            const result = await usersService.create(req.body); // Chama o service para criar usuário
    ...
    static async login(req, res) {
        console.log('users_publicController_login');
        try {
...
module.exports = Users_PublicController;